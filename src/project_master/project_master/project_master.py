...
def main():
    ...
    node.send_arm_request(0.22,0.0,-0.12,"PICKUP")
    node.send_arm_request(0.25,0.0,-0.12,"PICKUP")
    node.send_arm_request(0.27,0.0,-0.12,"PICKUP")
    node.send_arm_request(0.30,0.0,-0.12,"PICKUP")
